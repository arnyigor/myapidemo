...
public class GoogleOAuthActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener, View.OnClickListener {
	...
	public void onClick(View view) {
		switch (view.getId()) {
			case R.id.activity_button_sign_in:
				...
				break;
			case R.id.button4:
				ApiService.apiBuildRequest("https://www.googleapis.com/oauth2/v3/tokeninfo?access_token=" + mAccessToken, Method.GET, null, new OnStringRequestResult() {
					@Override
	...
	private void getAccessToken(String authCode) throws JSONException {
		...
		ApiService.apiBuildPostRequest("https://www.googleapis.com/oauth2/v4/token", Request.Method.POST, params,headers, new OnJSONObjectResult() {
			@Override
